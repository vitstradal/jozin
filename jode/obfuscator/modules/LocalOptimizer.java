...
public class LocalOptimizer implements Opcodes, CodeTransformer {
	...
	void combineInto(LocalInfo l) {
	    ...
	    Enumeration eenum = usingInstrs.elements();
	    while (eenum.hasMoreElements()) {
		InstrInfo instr = (InstrInfo) eenum.nextElement();
		instr.local = l;
	...
	public int getFirstAddr() {
	    ...
	    Enumeration eenum = usingInstrs.elements();
	    while (eenum.hasMoreElements()) {
		InstrInfo info = (InstrInfo) eenum.nextElement();
	...
	Enumeration eenum = v2.elements();
	while (eenum.hasMoreElements()) {
	    Object elem = eenum.nextElement();
	...
	Enumeration eenum = locals.elements();
	while (eenum.hasMoreElements()) {
